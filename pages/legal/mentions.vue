<template>
  <div class="relative py-20 px-5">
    ...
    <ul>
      ...
      <li>Responsable publication : Corentin PERROUX – corentin7301@gmail.com
        Le responsable publication est une personne physique ou une personne morale.</li>
      <li>Développeur : Corentin PERROUX – corentin7301@gmail.com
      </li>
    ...
    <p>L’utilisation du site https://know-wildlife.fr implique l’acceptation pleine et entière des conditions générales
    ...
    <p>Le site https://know-wildlife.fr a pour objet de fournir des informations concernant les animaux sauvages.</p>
    <p>Corentin PERROUX s’efforce de fournir sur le site https://know-wildlife.fr des informations aussi précises que
    ...
    <p>Corentin PERROUX est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur tous
      les
    ...
    <p>Corentin PERROUX ne pourra être tenue responsable des dommages directs et indirects causés au matériel de
    ...
    <p>Le site https://know-wildlife.fr contient un certain nombre de liens hypertextes vers d’autres sites, mis en
      place
    ...
    <h2>9. Droit applicable et attribution de juridiction.
    </h2>
    <p>Tout litige en relation avec l’utilisation du site https://know-wildlife.fr est soumis au droit français. Il est
    ...
    <h2>11. Lexique.</h2>
    <p>Utilisateur : Internaute se connectant, utilisant le site susnommé.<br />Informations personnelles : « les
